                    ...
                    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                        <jet-form-section @submitted="storeFamiliar">
                            ...
                            <template #description>
                                <span class="block mb-5">Change existing familiar's data.</span>
                                <inertia-link :href="'/familiar/view/' + familiar.slug" class="my-5 text-blue-400 hover:text-blue-700" v-if="familiar.current_image_url">
                                    <img :src="familiar.current_image_url" alt="kin">
...
export default {
    ...
    methods: {
        storeFamiliar: function() {
            this.form.put(route('admin.familiar.update', this.familiar.id), {
        ...
        prepareForm: function() {
            this.$inertia.reload({
                data: {
                    owner: this.familiar.gaian.name,
                    kin: this.familiar.kin.name ? this.familiar.kin.name : null,
                    colorist: this.familiar.colorist ? this.familiar.colorist : null,
                    familiar_species: this.familiar.species ? this.familiar.species.name : null,
                }
            });

            this.form.name = this.familiar.name;
            this.form.familiar_species = this.familiar.species;
            this.form.current_image_url = this.familiar.current_image_url;
            this.form.cert_url = this.familiar.cert_url;
            this.form.kin = this.familiar.kin;
            this.form.owner = this.familiar.gaian;
            this.form.colorist = this.familiar.colourist;
        }
    },
}
</script>